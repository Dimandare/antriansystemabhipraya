		...
		<div class="row">
			<div class="col-md-4 offset-md-4">
				<div class="card card-default">
					<div class="card-header"><strong>Login Atasan</strong></div>
					<div class="card-body">
						<form method="post" action="/Atasan" enctype="multipart/form-data">
							@csrf <!-- {{ csrf_field() }} -->
							...
							<div class="form-group row">
														<label class="col-form-label col-sm-4" for="kode_akses">1 + 9 = </label>
							<div class="col-sm-8">
								<input type="hidden" name="kode" value="10">
